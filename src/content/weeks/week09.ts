  ...
  lessons: [
    {
      ...
      exercise: {
        ...
        steps: [
          ...
          { n: 2, title: 'Verlaag de warmte', text: 'Zit je bij pan 3 of hoger? Doe dan eerst je ademanker of de 5-4-3-2-1. Oplossen komt zo.', seconds: 120 },
    ...
    },
    {
      ...
      assignment: 'Let deze week op je piekermomenten. Zet bij elke zorg de vraag: kan ik hier iets aan doen? Schrijf het antwoord er even bij.',
    ...
    },
    {
      ...
      intro: [
        ...
        'Neem bij deze oefening een echt probleem. Klein is prima. Een onbeantwoorde mail of een afspraak verzetten is prima oefenmateriaal.'
      ],
      metaphorCard: {
      ...
      exercise: {
        ...
        steps: [
          { n: 1, title: 'Word rustig', text: 'Check je pannetje. Zit je hoog? Doe dan eerst een minuut je ademanker.', seconds: 60 },
          { n: 2, title: 'Benoem het probleem', text: 'Schrijf het probleem in één korte zin op. Concreet en klein.', seconds: 60 },
          { n: 3, title: 'Check je beeld', text: 'Kijk je misschien door een oude bril van vroeger? Vraag je af: is dit echt zo, of denk ik dat alleen van vroeger? Wat zou een lieve vriend of vriendin zeggen?', seconds: 90 },
          { n: 4, title: 'Kies: oplossen of accepteren', text: 'Kun je dit probleem beïnvloeden? Nee? Kies dan accepteren en gebruik je oefeningen uit week 3. Ja? Ga verder.', seconds: 60 },
          ...
          { n: 7, title: 'Maak je plan', text: 'Wat is je eerste kleine stap? Wanneer doe je hem? Wie kan helpen? Kijk later vriendelijk terug: hoe ging het?', seconds: 60 }
        ]
      },
      reflection: 'De eerste keer voelt dit plan misschien onwennig. Dat hoort erbij bij iets nieuws. Elke keer dat je het doorloopt, wordt het pad begaanbaarder.',
    ...
    },
    {
      ...
      exercise: {
        ...
        steps: [
          ...
          { n: 3, title: 'Vooruit kijken', text: 'Welke stap van het plan was lastig? Wat helpt je om die volgende week makkelijker te maken?', seconds: 45 }
        ]
      },
...
export const week09Flashcards: Flashcard[] = [
  ...
  },
  {
    id: 'w09-l03-f3',
    lessonId: 'w09-l03',
    front: 'Wat als je maar één oplossing kunt bedenken?',
  ...
  },
  {
    ...
    back: 'Sommige dingen kun je niet veranderen, zoals het verleden of andermans gevoelens. Vechten kost daar alleen maar energie. Accepteren geeft die energie terug.'
  },
  {
    id: 'w09-l04-f2',
    lessonId: 'w09-l04',
