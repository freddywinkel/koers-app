...
export const week06: Week = {
  ...
  tagline: 'Halverwege: versterken wat je al kunt.',
  lessons: [
    {
      id: 'w06-l01',
      weekId: 'w06',
      ...
      intro: [
        ...
        'Belangrijk: dit is niet weglopen. Je vlucht niet weg voor het gevoel. Je kiest er bewust voor even ergens anders te kijken. Later kun je terugkomen.'
      ],
      metaphorCard: {
      ...
      exercise: {
        ...
        steps: [
          ...
          { n: 2, title: 'Verzamel activiteiten', text: 'Noteer drie dingen die je aandacht trekken: muziek, wandelen, puzzelen, koken. Gewoon dingen die jij fijn vindt.', seconds: 90 },
    ...
    },
    {
      ...
      intro: [
        ...
        'Deze les is een quiz waarin je jezelf test. Niet om punten te scoren. Juist door te proberen te herinneren, blijft het beter hangen.'
      ],
      exercise: {
        title: 'Quiz: test jezelf in 4 stappen',
        steps: [
          { n: 1, title: 'Week 1 en 2', text: 'Wat zeggen de vijf pannen over je gevoel? En wat doe je als je zonder oordeel observeert?', seconds: 90 },
          ...
          { n: 4, title: 'Week 5', text: 'Wat is het waarnemende zelf? Noem één beeld dat je is bijgebleven: schaakbord of hemel.', seconds: 90 }
        ]
      },
    ...
    },
    {
      ...
      exercise: {
        ...
        steps: [
          { n: 1, title: 'Kijk terug', text: 'Blader door de lessen van week 1 tot en met 5. Welke oefeningen deden iets voor jou?', seconds: 60 },
    ...
    },
    {
      ...
      minutes: 5,
      intro: [
        'Je staat halverwege. Dat is een echt moment om even bij stil te staan. Niet om te beoordelen, maar om te kijken wat jou tot nu toe helpt.',
        'Misschien gaat het oefenen elke dag goed. Misschien lukte het niet elke dag. Beide zeggen iets waardevols over wat jij nodig hebt.'
      ],
      exercise: {
        title: 'Halverwege in 4 stappen',
        steps: [
          { n: 1, title: 'Kijk naar je week', text: 'Hoe vaak heb je geoefend of een les gedaan? Maak rustig een schatting, zonder oordeel.', seconds: 60 },
          { n: 2, title: 'Noem wat helpt', text: 'Wat heeft jou tot nu toe het meest geholpen? Een beeld, een oefening, een zin. Schrijf er één op.', seconds: 90 },
      ...
      reflection: 'Even kijken hoe het gaat, nu je halverwege bent, is al iets om trots op te zijn. Of je nu veel of weinig oefende: je bent er nog, en dat telt.',
      assignment: 'Vertel deze week aan iemand die je vertrouwt één ding dat je hebt geleerd. Hardop zeggen helpt om het te laten beklijven.',
      relatedSkillIds: [],
...
export const week06Flashcards: Flashcard[] = [
  {
    ...
    back: 'Bewust kiezen waar je aandacht heengaat, bijvoorbeeld naar een fijne of nuttige activiteit. Jij richt de lamp, niet je hoofd.'
  },
  {
    id: 'fc-w06-l01-b',
    lessonId: 'w06-l01',
    front: 'Wat is het verschil tussen verplaatsen en vermijden?',
    back: 'Bij vermijden vlucht je en kom je nooit terug. Bij verplaatsen kíes je even voor rust, en je kunt later terugkomen. De keuze is van jou.'
  },
  {
    id: 'fc-w06-l01-c',
    lessonId: 'w06-l01',
    front: 'Wat betekent helemaal meedoen?',
    back: 'Een activiteit helemaal doen, met al je aandacht. Je ruikt echt, kijkt echt en voelt echt. Half meedoen geeft je hoofd weer ruimte om te piekeren.'
  },
  {
    id: 'fc-w06-l02-a',
    lessonId: 'w06-l02',
    front: 'Wat betekent pan 4 (Pruttelt) in het pannetjesmodel?',
    back: 'Je voelt je echt niet lekker en je controle wordt kleiner. Tijd voor sterke vaardigheden, zoals gronden met je zintuigen.'
  },
  {
    id: 'fc-w06-l02-b',
    lessonId: 'w06-l02',
  ...
  },
  {
    ...
    back: 'Herhaling maakt een vaardigheid sterker en sneller paraat. Je traint op rustige momenten, zodat het ook werkt als het stormt.'
  },
  {
    id: 'fc-w06-l03-b',
    lessonId: 'w06-l03',
  ...
  },
  {
    ...
    back: 'Zacht opnieuw beginnen, kleiner dan je denkt. Twee minuten telt ook. Terugkomen mag altijd, ook na een week zonder oefenen.'
  }
];
