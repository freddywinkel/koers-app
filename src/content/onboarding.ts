 ...
 * Koers — onboarding
 * ---------------------------
 * Vijf korte welkomstschermen voor nieuwe gebruikers.
 * B1, warm en rustig. Scherm 5 bevat de verplichte crisis-disclaimer.
 */
...
export const onboarding: { titel: string; tekst: string }[] = [
  ...
  },
  {
    ...
    tekst: 'Je emoties zijn als pannen op een fornuis. Pan 1 is Rustig, pan 5 is Kookt over. In de app geef je aan in welke pan je nu zit. Zo krijg je precies de vaardigheid die nu past: zacht bij een lage pan, stevig bij een hoge pan.'
  },
  {
